...
// register
if(isset($_POST['contact_form']) && isset($_POST['email']))
{
...
//     print_r($getContactClass);
    ...
    $fullname= strip_tags($getContactClass->fullname);
...
<?php if(count($files) < 1 || $_SESSION[$_SESSION['username'].'is_pro_user'] == true): ?>
    ...
    <?php 
    if(isset($_SESSION['username']) && $_SESSION[$_SESSION['username'].'is_pro_user']):
...
<!--  -->
    ...
    <div class="padding">
        ...
        <div class="form-group">
            <input type="submit" class="btn btn-primary" name="contact_form" value="Submit" />
        </div>
    </form>
    <?php else: ?>

        <p> Hello <?= $fullname ?>, we will contact shortly on <?= $email ?>
